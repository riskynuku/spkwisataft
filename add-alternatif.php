              ...
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="breadcomb-wp">
                  ...
                  <div class="breadcomb-ctn">
                    <h2>Tambah Data Alternatif Fuzzy</h2>
                    ...
                    <div class="form-example-wrap mg-t-30">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <input type="text" name="id_alternatif" id="id_alternatif" class="form-control input-sm" placeholder="  Masukan ID" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-example-int form-horizental">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <input type="text" name="nama_alternatif" id="nama_alternatif" class="form-control input-sm" placeholder="  Masukan Nama" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-example-int form-horizental">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <input type="text" name="deskripsi" id="deskripsi" class="form-control input-sm" placeholder="  Masukan Deskripsi" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-example-int form-horizental">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <input type="text" name="urlmap" id="urlmap" class="form-control input-sm" placeholder="  Masukan Url" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-example-int mg-t-15">
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                    <button type="submit" name="add" id="add" class="btn btn-success notika-btn-success">Tambah</button>
                                </div>
                            </div>
                        </div>
                        </form>
