...
<body>
	...
	?>
		<div class="container mb-5">
			<center>
				<img src="assets/jalann.png" width="200px" alt="">
				<h4 class="mx-lg-5 text-center my-4">Yuk, Cari Destinasi <br> Berdasarkan Kriteria Yang Kamu Inginkan</h4>
				<a href="#kategori" class="btn text-decoration-none rounded-pill btn-success mx-lg-2">
					Kategori
				</a>
				<a href="index.php" class="btn text-decoration-none rounded-pill btn-outline-success">
					Kembali
				</a>
			</center>
			<form class="row g-3 mt-1" id="kategori" name="form1" method="post" action="">
				...
				?>
				<div class="col-md-4">
					<input type="submit" name="button" id="button" value="Proses" class="tombol btn btn-success rounded-3 hasil_btn" />
				</div>
			</form>
		</div>
	<?php
	...
	?>
					...
					<table border="0" class="table table-hover">
						...
						while ($dataalternatif = mysqli_fetch_array($queryalternatif)) {
							...
							if ($termasuk == true) {
								...
								$gambar[$i] = $dataalternatif['gambar'];
								$urlmap[$i] = $dataalternatif['urlmap'];
		...
		<div class="container">
			<input type="button" class="btn btn-success rounded-3 mt-2" value="Lihat Hasil Detail" onclick="document.getElementById('perhitungan').style.display='block';" />
			<h4 class="mt-5 mb-3">Hasil Analisa Destinasi Wisata Metode Fuzzy Tahani</h4>
			<?php
			...
			<table class="table table-hover" border="0">
				...
				?>
					<tr>
						<td><?php echo ($i + 1); ?></td>
						<td><a href="<?php echo $urlmap[$i];?>"><img src="<?php echo $gambar[$i];?>" width="70" height="50"/></a></td>
