                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd" style="text-align: right;">
                            <a data-toggle="tooltip" data-placement="left" title="Tambah Kriteria" href="add-admin.php"><span class="btn-lg btn-success success-icon-notika btn-reco-mg btn-button-mg notika-icon notika-plus-symbol"> Tambah</span></a>
                        </div>
                        <div class="table-responsive">
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                                <?php
                                $queryadmin = mysqli_query($db, "SELECT * FROM admin ORDER BY username");
                                while ($dataadmin = mysqli_fetch_array($queryadmin))
                                      {
                                        ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          <a href="edit-admin.php?username=<?php echo $dataadmin['username']; ?>" class="btn btn-success success-icon-notika btn-reco-mg btn-button-mg notika-icon notika-edit" data-toggle="tooltip" title="Ubah"></a>
                                          <a href="del-admin.php?username=<?php echo $dataadmin['username']; ?>" class="btn btn-danger danger-icon-notika btn-reco-mg notika-icon notika-trash" data-toggle="tooltip" title="Hapus"></a>
                                        </td>
                                    </tr>
                                      <?php
                                      }
