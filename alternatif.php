            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        <!--<li class="active"><a data-toggle="tab" href="#Tables"><i class="notika-icon notika-house"></i> Beranda</a>
                        </li>-->
            ...
            <div class="row">
              ...
              <!--<div class="col-lg-6 col-md-6 col-sm-6 col-xs-3">
                <div class="breadcomb-report">
                  <a data-toggle="tooltip" data-placement="left" title="Tambah Alternatif" href="add-alternatif.php"><span class="btn-lg btn-success success-icon-notika btn-reco-mg btn-button-mg notika-icon notika-plus-symbol"> Tambah</span></a>
                </div>
              </div>-->
            </div>
          </div>
                            ...
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><div class="card_destination"><img src="<?php echo $dataalternatif['gambar'];?>" width="50" height="40"/></div></td>
                                        <td><?php echo $dataalternatif['urlmap']; ?></td>
                                        <td>
                                          <a href="edit-alternatif.php?id_alternatif=<?php echo $dataalternatif['id_alternatif']; ?>" class="btn btn-success success-icon-notika btn-reco-mg btn-button-mg notika-icon notika-edit" data-toggle="tooltip" title="Ubah"></a>
                                          <a href="del-alternatif.php?id_alternatif=<?php echo $dataalternatif['id_alternatif']; ?>" class="btn btn-danger danger-icon-notika btn-reco-mg notika-icon notika-trash" data-toggle="tooltip" title="Hapus"></a>
                                        </td>
                                    </tr>
                                      <?php
                                        }
