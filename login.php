...
if (isset($_POST['button'])) {
  $querylogin = mysqli_query($db, "SELECT * FROM admin WHERE username = '$_POST[username]' AND password = '$_POST[password]'");
...
<head>
  <title>SPK Destinasi Wisata Fuzzy Tahani</title>
  <meta charset="UTF-8">
      ...
      <div class="col col-sm-10 col-lg-4">
        <form id="form1" name="form1" method="post" action="">
          <div class="mb-3">
            ...
            <input type="text" name="username" id="username" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required>
          </div>
          <div class="mb-3">
          ...
          <input type="submit" class="btn btn-success" name="button" id="button" value="Login" />
          <a class="btn btn-success" href="index.php">Beranda</a>
        </form>
      </div>
      <div class="col col-sm-1 col-lg-4"></div>
    </div>
