<?php
    ...
    {
        mysqli_query($db, "UPDATE admin SET nama_admin='$_POST[nama_admin]', username='$_POST[username]', password='$_POST[password]' WHERE username='$_POST[username]'");
                    ...
                    <div class="form-example-wrap mg-t-30">
                        <div style="text-align: center;" class="basic-tb-hd">
                            <h2>Ubah Admin</h2>
                             ...
                             <?php
                                $queryadmin = mysqli_query($db, "SELECT * FROM admin WHERE username = '$_GET[username]'");
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <input type="text" name="username" id="username" readonly value="<?php echo $dataadmin['username']; ?>" class="form-control input-sm" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-example-int form-horizental mg-t-15">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <input type="text" name="password" id="password" value="<?php echo $dataadmin['password']; ?>" class="form-control input-sm" placeholder="Masukan Password" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-example-int form-horizental">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <input type="text" name="nama_admin" id="nama_admin" value="<?php echo $dataadmin['nama_admin']; ?>" class="form-control input-sm" placeholder="Masukan Nama Lengkap" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
