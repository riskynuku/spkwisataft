            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        <!--<li class="active"><a href="alternatif.php"><i class="notika-icon notika-house"></i> Beranda</a>
                        </li>-->
            ...
            <div class="row">
              ...
              <!--<div class="col-lg-6 col-md-6 col-sm-6 col-xs-3">
                <div class="breadcomb-report">
                  <a data-toggle="tooltip" data-placement="left" title="Tambah Kriteria" href="add-kriteria-fuzzy.php"><span class="btn-lg btn-success success-icon-notika btn-reco-mg btn-button-mg notika-icon notika-plus-symbol"> Tambah</span></a>
                </div>
              </div>-->
            </div>
          </div>
                        ...
                        <div class="table-responsive">
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                while ($datakriteria = mysqli_fetch_array($querykriteria))
                                    ...
                                    <tr>
                                        <td><?php echo $datakriteria['id_kriteria_fuzzy']; ?></td>
                                        <td><?php echo $datakriteria['nama_kriteria_fuzzy']; ?></td>
                                        <td><?php echo $datakriteria['batas_bawah']; ?></td>
                                        <td><?php echo $datakriteria['batas_tengah']; ?></td>
                                        <td><?php echo $datakriteria['batas_atas']; ?></td>
                                        <td><?php echo $datakriteria['nama_bawah']; ?></td>
                                        <td><?php echo $datakriteria['nama_tengah']; ?></td>
                                        <td><?php echo $datakriteria['nama_atas']; ?></td>
                                        <td>
                                          <a href="edit-kriteria-fuzzy.php?id_kriteria_fuzzy=<?php echo $datakriteria['id_kriteria_fuzzy']; ?>" class="btn btn-success success-icon-notika btn-reco-mg btn-button-mg notika-icon notika-edit" data-toggle="tooltip" title="Ubah"></a>
                                          <a href="del-kriteria-fuzzy.php?id_kriteria_fuzzy=<?php echo $datakriteria['id_kriteria_fuzzy']; ?>" class="btn btn-danger danger-icon-notika btn-reco-mg notika-icon notika-trash" data-toggle="tooltip" title="Hapus"></a>
                                        </td>
                                    </tr>
                                      <?php
                                      }
