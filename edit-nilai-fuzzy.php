                    ...
                    <div class="form-example-wrap mg-t-30">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
                                        <label class="hrzn-fm">ID Nilai Fuzzy<span style="color: red;"> *</span></label>
                                    </div>
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <input type="text" name="id_nilai_fuzzy" id="id_nilai_fuzzy" readonly value="<?php echo $datanilai['id_nilai_fuzzy']; ?>" class="form-control input-sm" placeholder="  Masukan ID Nilai" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-example-int form-horizental">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
                                        <label class="hrzn-fm">Pilih Alternatif<span style="color: red;"> *</span></label>
                                    </div>
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="chosen-select-act fm-cmp-mg">
                                        <select name="id_alternatif" id="id_alternatif" class="chosen" data-placeholder="Pilih Alternatif...">
                                            <option value=""></option>
    						                <?php
                        ...
                        <div class="form-example-int form-horizental mg-t-15">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
                                        <label class="hrzn-fm">Pilih Kriteria<span style="color: red;"> *</span></label>
                                    </div>
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="chosen-select-act fm-cmp-mg">
                                        <select name="id_kriteria_fuzzy" id="id_kriteria_fuzzy" class="chosen" data-placeholder="Pilih Kriteria...">
                                            <option value=""></option>
							                <?php
                        ...
                        <div class="form-example-int form-horizental">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
                                        <label class="hrzn-fm">Masukan Nilai<span style="color: red;"> *</span></label>
                                    </div>
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <input type="text" name="nilai" id="nilai" value="<?php echo $datanilai['nilai']; ?>" class="form-control input-sm" placeholder="   Masukan Nilai" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
